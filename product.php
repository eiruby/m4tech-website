<?php
    ...
    $categ_name = $_SESSION['categ_name'];
    $sql = "SELECT * FROM $categ_name;";
...
<head>
    ...
    <title>M4Tech - <?php echo $categ_name ?></title>
            ...
            <div class="d-flex">
                ...
                <div class="container">
                    ...
                    <div class="row my-2 g-3">
                        <?php
                        $items = mysqli_query($conn, "SELECT * FROM $categ_name;");
                        while($row = mysqli_fetch_assoc($items)){
                        ?>
                        <div class="col-11 col-md-6 col-lg-2">
                            <div class="card h-100">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <img class="img-fluid p-3" width="150" src="images/processor/<?php echo $row['proc_img'] ?>.png" alt="image">
                                </div>
                                <div class="px-3 pb-3">
                                    <p class="m-0">
