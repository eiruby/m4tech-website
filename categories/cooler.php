...
<head>
    ...
    <title>M4Tech - Fan & Heatsink</title>
                ...
                <div class="container">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Fan & Heatsink</li>
                        </ol>
                    </nav>
                    <!-- Sorter -->
                    <div class="d-flex justify-content-between">
                        <h3 class="my-auto me-3 me-lg-0">Fan & Heatsink</h3>
                    ...
                    <div class="row mt-2 mb-5 g-2">
                        <?php
                        $cooler = mysqli_query($conn, "SELECT * FROM cooler;");
                        while($row = mysqli_fetch_assoc($cooler)){
                        ?>
                        <div class="col-11 col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm" style="width: 13rem;">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <img class="img-fluid p-3" width="180" src="../images/cooler/<?php echo $row['fan_img'] ?>.png" alt="image">
                                </div>
                                <div class="px-3 pb-3">
                                    <p class="m-0">
                                        <span class="fs-6 fs-lg-5"><b><?php echo $row['fan_name'] ?></b></span><br>
                                        Php <?php echo $row['fan_price'] ?>.00
                                    </p>
                                </div>
                            </div>
                        </div>
