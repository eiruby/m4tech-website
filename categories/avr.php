                ...
                <div class="container">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">AVR</li>
                        </ol>
                    </nav>
                    <!-- Sorter -->
                    <div class="d-flex justify-content-between">
                        <h3 class="my-auto me-3 me-lg-0">AVR</h3>
                    ...
                    <div class="row mt-2 mb-5 g-2">
                        <?php
                        $avr = mysqli_query($conn, "SELECT * FROM avr;");
                        while($row = mysqli_fetch_assoc($avr)){
                        ?>
                        <div class="col-11 col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm" style="width: 13rem;">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <img class="img-fluid p-3" width="180" src="../images/avr/<?php echo $row['avr_img'] ?>.png" alt="image">
                                </div>
                                <div class="px-3 pb-3">
                                    <p class="m-0">
                                        <span class="fs-6 fs-lg-5"><b><?php echo $row['avr_name'] ?></b></span><br>
                                        Php <?php echo $row['avr_price'] ?>.00
                                    </p>
                                </div>
                            </div>
                        </div>
