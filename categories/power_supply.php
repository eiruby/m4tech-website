...
<head>
    ...
    <title>M4Tech - Power Supply</title>
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle link-light" href="#" href="#" href="#" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">Products</a>
            ...
            <div class="d-flex">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between">
                        <h3 class="my-auto me-3 me-lg-0">Power Supply</h3>
                    ...
                    <div class="row mt-2 mb-5 g-2">
                        <?php
                        $power_supply = mysqli_query($conn, "SELECT * FROM power_supply;");
                        while($row = mysqli_fetch_assoc($power_supply)){
                        ?>
                        <div class="col-11 col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm" style="width: 13rem;">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <img class="img-fluid p-3" width="180" src="../images/power_supply/<?php echo $row['ps_img'] ?>.png" alt="image">
                                </div>
                                <div class="px-3 pb-3">
                                    <p class="m-0">
                                        <span class="fs-6 fs-lg-5"><b><?php echo $row['ps_name'] ?></b></span><br>
                                        Php <?php echo $row['ps_price'] ?>.00
                                    </p>
                                </div>
                            </div>
                        </div>
