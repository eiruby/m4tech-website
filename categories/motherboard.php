...
<head>
    ...
    <title>M4Tech - Motherboard</title>
                                        ...
                                        <div class="accordion-body p-3">
                                            <form action="">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Max" min="100" max="30000" aria-label="Max" fdprocessedid="x7mjyb">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Motherboard</li>
                        </ol>
                    </nav>
                    <!-- Sorter -->
                    <div class="d-flex justify-content-between">
                        <h3 class="my-auto me-3 me-lg-0">Motherboard</h3>
                    ...
                    <div class="row mt-2 mb-5 g-2">
                        <?php
                        $motherboard = mysqli_query($conn, "SELECT * FROM motherboard;");
                        ...
                        <div class="col-11 col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm" style="width: 13rem;">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <img class="img-fluid p-3" width="180" src="../images/motherboard/<?php echo $row['mb_img'] ?>.png" alt="image">
                                </div>
                                <div class="px-3 pb-3">
                                    <p class="m-0">
                                        <span class="fs-6 fs-lg-5"><b><?php echo $row['mb_name'] ?></b></span><br>
                                        Php <?php echo $row['mb_price'] ?>.00
                                    </p>
                                </div>
                            </div>
                        </div>
